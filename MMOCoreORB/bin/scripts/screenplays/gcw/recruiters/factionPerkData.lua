...
rebelRewardData = {
	weaponsArmorList = {
		"armor_marine_backpack", "armor_marine_chest_plate", "armor_marine_helmet", "armor_marine_boots", "armor_marine_leggings", "armor_marine_bicep_l",
		"armor_marine_bicep_r","armor_marine_bracer_l", "armor_marine_bracer_r", "carbine_laser", "pistol_scout_blaster", "lance_staff_metal", "rocket_launcher", "mine_drx", "mine_xg", "reb_cape", "reb_barc"
	},
	...
	weaponsArmor = {
		...
		armor_marine_chest_plate = { index=1, type=factionRewardType.armor, display="@wearables_name:armor_marine_chest_plate_gcw", item="object/tangible/loot/factional_schematic/rebel_marine_chest_plate_gcw_schematic.iff",cost=20000},
		armor_marine_helmet = { index=2, type=factionRewardType.armor, display="@wearables_name:armor_marine_helmet_gcw", item="object/tangible/loot/factional_schematic/rebel_marine_helmet_gcw_schematic.iff",cost=20000},
		armor_marine_boots = { index=3, type=factionRewardType.armor, display="@wearables_name:armor_marine_boots_gcw", item="object/tangible/loot/factional_schematic/rebel_marine_boots_gcw_schematic.iff",cost=20000},
		armor_marine_leggings = { index=4, type=factionRewardType.armor, display="@wearables_name:armor_marine_leggings_gcw", item="object/tangible/loot/factional_schematic/rebel_marine_leggings_gcw_schematic.iff",cost=20000},
		armor_marine_bicep_l = { index=5, type=factionRewardType.armor, display="@wearables_name:armor_marine_bicep_l_gcw", item="object/tangible/loot/factional_schematic/rebel_marine_bicep_l_gcw_schematic.iff",cost=20000},
		armor_marine_bicep_r = { index=6, type=factionRewardType.armor, display="@wearables_name:armor_marine_bicep_r_gcw", item="object/tangible/loot/factional_schematic/rebel_marine_bicep_r_gcw_schematic.iff",cost=20000},
		armor_marine_bracer_l = { index=7, type=factionRewardType.armor, display="@wearables_name:armor_marine_bracer_l_gcw", item="object/tangible/loot/factional_schematic/rebel_marine_bracer_l_gcw_schematic.iff",cost=20000},
		armor_marine_bracer_r = { index=8, type=factionRewardType.armor, display="@wearables_name:armor_marine_bracer_r_gcw", item="object/tangible/loot/factional_schematic/rebel_marine_bracer_r_gcw_schematic.iff",cost=20000},
		carbine_laser = { index=9, type=factionRewardType.weapon, display="@weapon_name:carbine_laser", item="object/weapon/ranged/carbine/carbine_laser.iff", cost=1500},
		pistol_scout_blaster = { index=10, type=factionRewardType.weapon, display="@weapon_name:pistol_scout_blaster", item="object/weapon/ranged/pistol/pistol_scout_blaster.iff", cost=1000},
		metal_staff = { index=11, type=factionRewardType.weapon, display="@weapon_name:sword_02", item="object/weapon/ranged/melee/sword/sword_02.iff", cost=1000},
		rocket_launcher = { index=12, type=factionRewardType.weapon, display="@weapon_name:rocket_launcher", item="object/weapon/ranged/heavy/heavy_rocket_launcher.iff", cost=5000},
		lance_staff_metal = { index=13, type=factionRewardType.weapon, display="@weapon_name:lance_staff_metal", item="object/weapon/melee/polearm/lance_staff_metal.iff", cost=1000},
		...
		reb_barc = { type=factionRewardType.weapon, display="@pet_deed:barc_speeder_rebel", item="object/tangible/loot/factional_schematic/rebel_barc_speeder_schematic.iff", cost=12500},
	},
...
imperialRewardData = {
	...
	weaponsArmor = {
		...
		armor_stormtrooper_bicep_l = { type=factionRewardType.armor, display="@wearables_name:armor_stormtrooper_bicep_l_gcw", item="object/tangible/loot/factional_schematic/imperial_stormtrooper_bicep_l_gcw_schematic.iff",cost=20000},
		armor_stormtrooper_bicep_r = { type=factionRewardType.armor, display="@wearables_name:armor_stormtrooper_bicep_r_gcw", item="object/tangible/loot/factional_schematic/imperial_stormtrooper_bicep_r_gcw_schematic.iff",cost=20000},
		armor_stormtrooper_boots = { type=factionRewardType.armor, display="@wearables_name:armor_stormtrooper_boots_gcw", item="object/tangible/loot/factional_schematic/imperial_stormtrooper_boots_gcw_schematic.iff",cost=20000},
		armor_stormtrooper_chest_plate = { type=factionRewardType.armor, display="@wearables_name:armor_stormtrooper_chest_plate_gcw", item="object/tangible/loot/factional_schematic/imperial_stormtrooper_chest_plate_gcw_schematic.iff", cost=20000},
		armor_stormtrooper_helmet = { type=factionRewardType.armor, display="@wearables_name:armor_stormtrooper_helmet_gcw", item="object/tangible/loot/factional_schematic/imperial_stormtrooper_helmet_gcw_schematic.iff", cost=20000},
		armor_stormtrooper_leggings = { type=factionRewardType.armor, display="@wearables_name:armor_stormtrooper_leggings_gcw", item="object/tangible/loot/factional_schematic/imperial_stormtrooper_leggings_gcw_schematic.iff",cost=20000},
		armor_stormtrooper_bracer_l = { type=factionRewardType.armor, display="@wearables_name:armor_stormtrooper_bracer_l_gcw", item="object/tangible/loot/factional_schematic/imperial_stormtrooper_bracer_l_gcw_schematic.iff",cost=20000},
		armor_stormtrooper_bracer_r = { type=factionRewardType.armor, display="@wearables_name:armor_stormtrooper_bracer_r_gcw", item="object/tangible/loot/factional_schematic/imperial_stormtrooper_bracer_r_gcw_schematic.iff",cost=20000},
		armor_stormtrooper_gloves = { type=factionRewardType.armor, display="@wearables_name:armor_stormtrooper_gloves_gcw", item="object/tangible/loot/factional_schematic/imperial_stormtrooper_gloves_gcw_schematic.iff",cost=20000},
		armor_stormtrooper_utility_belt = { type=factionRewardType.armor, display="@wearables_name:armor_stormtrooper_utility_belt_gcw", item="object/tangible/loot/factional_schematic/imperial_stormtrooper_utility_belt_gcw_schematic.iff",cost=1400},
		...
		mine_drx = { type=factionRewardType.weapon, display="@weapon_name:mine_drx", item="object/weapon/mine/wp_mine_drx55.iff", cost=350},
		mine_xg = { type=factionRewardType.weapon, display="@weapon_name:mine_xg", item="object/weapon/mine/wp_mine_xg.iff", cost=350},
		imp_barc = { type=factionRewardType.weapon, display="@pet_deed:barc_speeder_imperial", item="object/tangible/loot/factional_schematic/imperial_barc_speeder_schematic.iff", cost=12500},
	},
