...
bountyhuntermaster = { {"firelightningcone1",""},{"firelightningcone2",""},{"firelightningsingle1",""},{"firelightningsingle2",""},{"bleedingshot",""},{"underhandshot",""},{"eyeshot",""},{"knockdownfire",""},{"torsoshotnpc",""},{"confusionshot",""},{"fastblast",""},{"sprayshot",""} }
...
forcepowermaster = { {"forcelightningsingle2",""},{"forcelightningcone2",""},{"mindblast2",""},{"forceknockdown2",""},{"forceweaken2",""},{"forcethrow2",""},{"forcechokenpc",""} }

-- npc force wielders use standard profession mastery with the addition of this command
forcewielder ={ {"forcelightningsingle1",""},{"mindblast1",""},{"forcechokenpc",""},{"forceweaken1",""},{"forceknockdown1",""},{"forcelightningcone1",""} }
