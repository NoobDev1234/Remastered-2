...
ObjectTemplates:addClientTemplate(object_draft_schematic_bio_engineer_creature_shared_creature_mutrancor, "object/draft_schematic/bio_engineer/creature/shared_creature_mutrancor.iff")
