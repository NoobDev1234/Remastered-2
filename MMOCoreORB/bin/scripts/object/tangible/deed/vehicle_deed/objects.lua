...
--Sith
object_tangible_deed_vehicle_deed_shared_speeder_sith_deed = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/deed/vehicle_deed/shared_speeder_sith_deed.iff"
}
ObjectTemplates:addClientTemplate(object_tangible_deed_vehicle_deed_shared_speeder_sith_deed, "object/tangible/deed/vehicle_deed/shared_speeder_sith_deed.iff")
