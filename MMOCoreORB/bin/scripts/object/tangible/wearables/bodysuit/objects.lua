...
object_tangible_wearables_bodysuit_shared_bodysuit_outbreak_prisoner = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/wearables/bodysuit/shared_bodysuit_outbreak_prisoner.iff"
}
ObjectTemplates:addClientTemplate(object_tangible_wearables_bodysuit_shared_bodysuit_outbreak_prisoner, "object/tangible/wearables/bodysuit/shared_bodysuit_outbreak_prisoner.iff")
