...
object_intangible_beast_shared_bm_blackwing_rancor = SharedIntangibleObjectTemplate:new {
	clientTemplateFileName = "object/intangible/beast/shared_bm_blackwing_rancor.iff"
}

ObjectTemplates:addClientTemplate(object_intangible_beast_shared_bm_blackwing_rancor, "object/intangible/beast/shared_bm_blackwing_rancor.iff")
