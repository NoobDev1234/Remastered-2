...
bool PetControlDeviceImplementation::growPet(CreatureObject* player, bool force, bool adult) {
	...
	int stagesToGrow = timeDelta / 21600; // 12 hour
...
bool PetControlDeviceImplementation::isValidPet(AiAgent* pet) {
	...
	if (deed != NULL) {
		...
		info("Calculated Pet Level: " + String::valueOf(calculatedLevel));
		info("Template Level: " + String::valueOf(pet->getTemplateLevel()));
