...
void DnaManager::loadSampleData() {
	...
	try {
		...
		// pull stat balance out and set it up.
...
void DnaManager::generateSample(Creature* creature, CreatureObject* player,int quality){
	...
	//error( "Generate Sample Ham values: " + String::valueOf(creature->getMaxHAM(0)) + " : " + String::valueOf(creature->getMaxHAM(3)) );
	//error( "Quality: " + String::valueOf(quality) );
...
/*
	player->sendSystemMessage( "Object Name: " + String::valueOf( creature->getObjectName()) );
	player->sendSystemMessage( "Custom Object Name: " + creature->getCustomObjectName().toString() );
	player->sendSystemMessage( "Object Name: " + creature->getObjectNameStringIdName() );
	player->sendSystemMessage( "First Name: " +creature->getFirstName() );
	player->sendSystemMessage("Creature Name: " + creature->getCreatureName().toString() );
*/

	String creatureName = creature->getObjectNameStringIdName();
	...
	switch (quality){
		case 1:
			prototype->setCustomObjectName( creatureName + ":" + String::valueOf(cl) + "- Very High Quality",true);
			break;
		case 2:
			prototype->setCustomObjectName( creatureName + ":" + String::valueOf(cl) + "- High Quality",true);
			break;
		case 3:
			prototype->setCustomObjectName( creatureName + ":" + String::valueOf(cl) + "- Above Avg Quality",true);
			break;
		case 4:
			prototype->setCustomObjectName( creatureName + ":" + String::valueOf(cl) + "- Avg Quality",true);
			break;
		case 5:
			prototype->setCustomObjectName( creatureName + ":" + String::valueOf(cl) + "- Below Avg Quality",true);
			break;
		case 6:
			prototype->setCustomObjectName( creatureName + ":" + String::valueOf(cl) + "- Low Quality",true);
			break;
		case 7:
			prototype->setCustomObjectName( creatureName + ":" + String::valueOf(cl) + "- Very Low Quality",true);
			break;
		default:
			prototype->setCustomObjectName( creatureName + ":" + String::valueOf(cl) + "- Unknown Quality",true);
			break;
	}
