...
/*
	player->sendSystemMessage("Tame level :" + String::valueOf(templateLevel));
	player->sendSystemMessage("Max Level Of Pets :" + String::valueOf(maxLevelofPets));
	player->sendSystemMessage("Tame Aggro :" + String::valueOf(player->getSkillMod("tame_aggro")));
	player->sendSystemMessage("Creature isVicious :" + String::valueOf(creature->isVicious()));
	player->sendSystemMessage("Chance To Tame :" + String::valueOf(creature->getChanceToTame(player)));

	info( "Tame level :" + String::valueOf(templateLevel) );
	info( "Max Level Of Pets :" + String::valueOf(maxLevelofPets) );
	info( "Tame Aggro :" + String::valueOf(player->getSkillMod("tame_aggro")) );
	info( "Creature isVicious :" + String::valueOf(creature->isVicious()) );
	info( "Chance To Tame :" + String::valueOf(creature->getChanceToTame(player)) );
*/
